    ...
    $.ajax({
        ...
        success: function (response) {
            response.items.forEach(function (data) {
                ...
                $('#historyTable tr:last').after('<tr><td>' + data.text + '</td><td style="text-align: center;"><i class="fa ' + sentimentClass + ' fa-2x" aria-hidden="true"></i></td><td style="text-align: center;">' + data.result.confidence + '%</td><td>' + FormatDate(EpochToDate(data.requested)) + '</td></tr>');
            });
        },
